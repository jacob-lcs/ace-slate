...
<p align="center">
  ...
  <a href="packages/ace-slate/package.json">
...
If even that's not enough, you can always [read the source itself](packages/ace-slate), which is heavily commented.
